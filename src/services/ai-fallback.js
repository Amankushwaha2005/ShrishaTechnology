...
function replyForIntent(primary, combined, message) {
  ...
  switch (primary) {
    case "greeting":
      return "Namaste! Main Shrisha Technology ka assistant hoon. Aap website, app, logo ya student project ke baare me Hindi/English dono me pooch sakte ho — main samajh kar jawab dunga.";
    case "thanks":
      return "Welcome! Aur koi sawal ho to poochiye — ya WhatsApp +91 79920 20591 par direct team se baat kar sakte ho.";
    case "pricing":
      ...
      return "Website: Starter ~₹2,999 (1 page), Professional ~₹7,999 (5 pages), Premium/CMS ~₹12,999. Exact quote budget + pages batane par. /pricing ya WhatsApp +91 79920 20591.";
    case "website_build":
    ...
    case "app":
      return "App chahiye to batayein: Android only ya Android+iOS? Login chahiye? Play Store publish? MVP idea likh kar WhatsApp +91 79920 20591 par bhejo — package suggest karenge.";
    case "logo":
    ...
    case "contact":
      return "Direct baat: WhatsApp/call **+91 79920 20591**, email **mayankklush2006@gmail.com**, ya site par **/contact** form. Usually kuch hours me reply.";
    case "payment":
    ...
    case "yes":
      return "Great! Agla step: project type + budget + deadline likh kar WhatsApp +91 79920 20591 par bhejo, ya /contact form bharo. Team follow-up karegi.";
    case "no":
...
function fallbackReply(message, history = []) {
  ...
  if (!m) {
    return "Namaste! Main Shrisha Technology ka AI assistant hoon. Website, app, logo ya student project — jo bhi chahiye casual Hindi/English me likho.";
  }
  ...
  return `Main ${SITE_KNOWLEDGE.split("\n")[0]} ke baare me help karta hoon. Thoda clear likho — jaise "coaching website 5 page kitne me" ya "Android app cost" — ya WhatsApp +91 79920 20591 par baat karo.`;
}
